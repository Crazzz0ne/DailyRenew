...
@section('content')
    {{ html()->modelForm($role, 'PATCH', route('dashboard.auth.role.update', $role))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('dashboard.auth.role.index'), __('buttons.general.cancel')) }}
                </div><!--col-->
