{{ html()->modelForm($logged_in_user, 'PUT', route('dashboard.user.profile.update'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
@method('put')
...
<div class="row">
    <div class="col">
        ...
        <div class="form-group">
            @if($logged_in_user->remote_option == true)
                <input type="radio" name="remote_option" value="1" checked/> Yes
                <input type="radio" name="remote_option" value="0"/> No
            @else
                <input type="radio" name="remote_option" value="1"/> Yes
                <input type="radio" name="remote_option" value="0" checked/> No
            @endif
        </div>
...
<timezone-select :user="{{auth()->user()}}"></timezone-select>
<add-city-to-rep
    :user="{{auth()->user()}}">
