        ...
        <div class="card-header">
            ...
            @if( auth()->user()->roles[0]->name == 'administrator' || auth()->user()->roles[0]->name == 'executive')
                <div class="btn-toolbar float-right" role="toolbar">
                    ...
                    <a href="{{ route('admin.mastermind.content.create') }}" class="btn btn-success ml-1"
                       data-toggle="tooltip"
                                                    ...
                                                    <div class="pt-3">
                                                        <div class="float-left">
                                                            @if($content->type == 'youTube')
                                                                <a href="{{ route('admin.mastermind.content.show', $content->id) }}"
                                                        ...
                                                        <div class="btn-group float-right" role="group"
                                                            ...
                                                            <a href="{{ route('admin.mastermind.content.edit', $content->id) }}"
                                                               data-toggle="tooltip" data-placement="top" title=""
                                                               class="btn btn-primary" data-original-title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <form method="POST"
                                                                  action="{{ route('admin.mastermind.content.destroy', $content) }}">
                                            ...
                                            <div class="col-12">
                                                <div class="mx-1 mb-2">
                                                    @forelse($content->tags as $stuff)
                                                        <a href="/admin/mastermind/content/tag?tag={{$stuff->slug}}">#{{$stuff->name}}</a>
                                                    @empty
                                                    @endforelse
                                                </div>
                                            </div>
