...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            {{--                    <a href="{{ route('backend.training.content.create') }}" class="btn btn-success ml-1"--}}
            {{--                       data-toggle="tooltip"--}}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row justify-content-between py-2 my-2">
                        <div class="col">
                    <span>
                        <a href="/training/1/view?year={{ $lastYear }}">
                    <i class="fas fa-arrow-left fa-2x"> </i>
                        ...
                        <a href="/training/1/view?year={{ $currentYear +1 }}">
                                                ...
                                                <div class="pt-3">
                                                    <div class="float-left">
                                                        @if($content->type == 'youTube')
                                                            <a href="{{ route('frontend.training.content.show', $content->id) }}"
                                                    ...
                                                    @can('administrate all trainings')
                                                        <div class="btn-group float-right" role="group"
                                                            ...
                                                            <a href="{{ route('admin.training.content.edit', $content->id) }}"
                                                               data-toggle="tooltip" data-placement="top" title=""
                                                               class="btn btn-primary" data-original-title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <form method="POST"
                                                                  action="{{ route('admin.training.content.destroy', $content) }}">
                                            ...
                                            <div class="col-12">
                                                <div class="mx-1 mb-2">
                                                    @forelse($content->tags as $tag)
                                                        <a href="/training/contents/tag?tag={{$tag->slug}}">#{{$tag->name}}</a>
                                                    @empty
                                                    @endforelse
                                                </div>
                                            </div>
